...
// styles
const CHB = styled('main', { shouldForwardProp: (prop) => prop !== 'open' })(({ theme, open, layout }: MainStyleProps) => ({
...
const CHBLayout = () => {
    ...
    return (
        <Box sx={{ display: 'flex' }}>
            ...
            {/* main content */}
            <CHB theme={theme} open={drawerOpen} layout={layout}>
